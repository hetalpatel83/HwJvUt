...
//    }
    ...
    public void aUserShouldBeRegisterSuccessfully()
    {
      ...
      //WebElement registerElement = driver.findElement(By.linkText("Register"));
        ...
        clickElementBy(By.xpath("//input[@type='radio' and contains(@id,'gender-female') ]"));
        ...
        enterText(By.xpath(("//input[@type='text' and contains(@id,'FirstName')]")),"Hetal");
       ...
       // WebElement lastNameWebElement =driver.findElement(By.xpath("//input[@type='text' and contains(@id,'LastName')]"));
        ...
        enterText(By.xpath(("//input[@type='text' and contains(@id,'LastName')]")),"Patel");
        ...
        //WebElement emailWebElement =driver.findElement(By.xpath("//input[contains(@id,'Email')]"));
        //emailWebElement.sendKeys("hetalpatel" + System.currentTimeMillis() +"@gmail.com");
        enterText(By.xpath(("//input[contains(@id,'Email')]")),"hetalpatel" + System.currentTimeMillis() +"@gmail.com");
       ...
       // WebElement companyNameWebElement =driver.findElement(By.xpath("//input[@type='text' and contains(@name,'Company')]"));
        ...
        enterText(By.xpath(("//input[contains(@name,'Password')]")),"abcd1234");
        ...
        enterText(By.xpath(("//input[contains(@name,'ConfirmPassword')]")),"abcd1234");
    ...
    public void loginSuccessfully()
    {
        ...
        WebElement emailWebElement =driver.findElement(By.xpath("//input[@class='email']"));
        emailWebElement.sendKeys("hetalpatel" + System.currentTimeMillis() +"@gmail.com");
